...
for p in products:
    ...
    # ---------- EXTRAER URL DE LA IMAGEN (forzando lazy-load) ----------
    try:
...
# ---------- Escribir CSV ----------
fieldnames = ["Nombre", "Marca", "Precio_actual", "Precio_antiguo",
              "Precio_Oh", "SKU", "Categoria", "Enlace", "Stock", "Imagen_URL"]
...
with open(ruta_csv, "w", newline="", encoding="utf-8") as f:
    writer = csv.DictWriter(
        ...
        delimiter=";",          # punto y coma para compatibilidad con Excel
